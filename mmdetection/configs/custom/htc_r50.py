...
checkpoint_config = dict(interval=1, out_dir='work_dirs/htc_r50/')
log_config = dict(interval=50, hooks=[dict(type='TextLoggerHook')])
custom_hooks = [dict(type='NumClassCheckHook')]
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = '/home/synergy/yhk/MM/mmdetection/configs/custom/htc_r50_fpn_1x_coco_20200317-7332cf16.pth'
resume_from = None
workflow = [('train', 1)]
...
classes = ('Normal', )
work_dir = 'configs/custom/htc_r50/'
auto_resume = False
gpu_ids = [0, 1]
