...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='lgc',
                name='htcres2net101_coco',
                config=dict(
                    config='htcres2net101_crop_coco_larger_img',
                    exp_name='htcres2net101_crop_coco',
                    lr=0.004),
                group='baseline',
                entity=None))
    ])
...
holdout = 0
work_dir = 'configs/custom/h2res2net101_crop_coco_larger_img/'
auto_resume = False
gpu_ids = range(0, 2)
