...
train_pipeline = [
    ...
    dict(
        type='Resize', img_scale=[(1600, 1600), (1280, 1024)],
        keep_ratio=True),
...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(type='Pad', size_divisor=32),
            dict(
                type='RandomCrop', crop_size=(256, 256), crop_type='absolute'),
            dict(
                type='Resize',
                img_scale=[(1600, 1600), (1280, 1024)],
                keep_ratio=True),
            dict(type='RandomFlip', flip_ratio=0.5),
            dict(type='DefaultFormatBundle'),
            dict(
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='lgc',
                name='htcres2net101_coco_cropped_256256_to_larger',
                config=dict(
                    config='htcres2net101_cropped_256256_to_larger',
                    exp_name='htcres2net101_cropped_256256_to_larger',
                    lr=0.004),
                group='baseline',
                entity=None))
    ])
...
holdout = 0
work_dir = 'configs/custom/h2res2net101_cropped_256256_to_larger/'
auto_resume = False
gpu_ids = range(0, 2)
