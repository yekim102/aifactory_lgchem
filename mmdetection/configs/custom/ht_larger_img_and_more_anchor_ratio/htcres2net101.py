...
train_pipeline = [
    ...
    dict(
        type='Resize', img_scale=[(1400, 1400), (1300, 1300)],
        keep_ratio=True),
...
checkpoint_config = dict(
    interval=1, out_dir='work_dirs/htcres2net101_larger_moreanchor/')
log_config = dict(
    interval=1,
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='htcres2net101',
                config=dict(
                    config='htcres2net101',
                    exp_name='htcres2net101_larger_moreanchor',
                    lr=0.002),
                group='baseline',
                entity=None))
    ])
...
holdout = 0
work_dir = 'configs/custom/ht_larger_img_and_more_anchor_ratio'
auto_resume = False
gpu_ids = range(0, 2)
