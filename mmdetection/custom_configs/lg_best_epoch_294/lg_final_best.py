...
checkpoint_config = dict(
    interval=2, out_dir='work_dirs/lg_mask_final_shiftscale_cutout/')
log_config = dict(
    interval=5,
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='lgc',
                name='lg_mask_final_shiftscale_cutout',
                config=dict(
...
classes = ('Normal', )
work_dir = 'configs/custom_config/lg_mask_final_bset'
auto_resume = False
gpu_ids = range(0, 2)
