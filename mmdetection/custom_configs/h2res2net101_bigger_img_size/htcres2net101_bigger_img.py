...
train_pipeline = [
    ...
    dict(
        type='Resize', img_scale=[(2000, 2000), (1600, 1600)],
        keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(2000, 200), (1800, 1800), (1600, 1600)],
        flip=True,
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                config=dict(
                    ...
                    exp_name='htcres2net101_bigger_size',
                    lr=0.004),
                group='baseline',
                entity=None))
    ])
...
classes = ('Normal', )
holdout = 0
work_dir = 'custom_configs/h2res2net101_bigger_img_size/'
auto_resume = False
gpu_ids = range(0, 2)
