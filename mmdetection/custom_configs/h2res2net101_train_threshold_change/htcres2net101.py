...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(2000, 2000), (1600, 1600)], keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(2000, 2000), (1800, 1800), (1600, 1600)],
        flip=True,
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='lgc',
                name='htcres2net101_bigger_size',
                config=dict(
                    config='htcres2net101', exp_name='htcres2net101_bigger_size',
                    lr=0.004),
                group='baseline',
                entity=None))
    ])
...
classes = ('Normal', )
holdout = 0
work_dir = 'custom_configs/h2res2net101_bigger_size/'
auto_resume = False
gpu_ids = range(0, 2)
