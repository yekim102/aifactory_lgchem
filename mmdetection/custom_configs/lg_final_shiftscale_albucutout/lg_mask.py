...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(
                type='Albu',
                transforms=[
                    dict(type='Cutout', num_holes=8, max_h_size=72, max_w_size=72, fill_value=0, always_apply=False, p=0.5),
                    dict(
    ...
    test=dict(
        ...
        pipeline=[
            ...
            dict(
                type='MultiScaleFlipAug',
                img_scale=[(1600, 1600), (1500, 1500), (1400, 1400)],
                flip=True,
                flip_direction=['horizontal', 'vertical'],
                transforms=[
                    dict(type='Resize', keep_ratio=True),
...
checkpoint_config = dict(
    interval=2, out_dir='work_dirs/lg_mask_final_shiftscale_albucutout/')
log_config = dict(
    interval=5,
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='lgc',
                name='lg_mask_final_shiftscale_albucutout',
                config=dict(
...
classes = ('Normal', )
work_dir = 'custom_configs/lg_mask_final_shiftscale_albucutout'
auto_resume = False
gpu_ids = range(0, 2)
