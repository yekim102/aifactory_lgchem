...
train_pipeline = [
    ...
    dict(
        type='Resize', img_scale=[(2400, 2400), (1600, 1600)],
        keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(2400, 2400), (2048, 2048), (1600, 1600)],
        flip=True,
...
classes = ('Normal', )
holdout = 0
work_dir = 'custom_configs/h2res2net101_bigger_img/'
auto_resume = False
gpu_ids = range(0, 2)
